...
function drawInfoWindow(property) {
  ...
  var description =
    "lorem ipsum dolor sit amet, cfeugiat congue qmper lorem ipsum dolor sit amet";
  ...
  ibContent =
    ...
    "<div class='map-content-top'><h4><a href='properties-details.html'>" +
    title +
    "</a></h4>" +
    ...
    "<span><i class='flaticon-square-layouting-with-black-square-in-east-area'></i>  " +
    area +
    " sqft<sup>2</sup></span> " +
    "<span><i class='flaticon-bed'></i>  " +
    Beds +
    " Bed</span> " +
    "<span><i class='flaticon-bath'></i>  " +
    bathroom +
    " Bath</span> " +
    "<span><i class='flaticon-car-repair'></i>    " +
    garage +
    " Garages</span> " +
    "</div>" +
...
function insertPropertyToArray(property, layout) {
  ...
  if (layout == "grid_layout") {
    element +=
      ...
      '                                    <img src="' +
      image +
      '" alt="property-2" class="img-fluid">\n' +
      "                                </a>" +
      ...
      "                                    </li>\n" +
      "                                    <li>\n" +
      '                                        <i class="flaticon-square-layouting-with-black-square-in-east-area"></i> Sq Ft:' +
      area +
      "\n" +
      "                                    </li>\n" +
      "                                    <li>\n" +
    ...
    element =
      ...
      '                                    <img src="' +
      image +
      '" alt="property-1" class="img-fluid">\n' +
